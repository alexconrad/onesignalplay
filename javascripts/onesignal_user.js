...
OneSignal.push(function() {
    ...
    OneSignal.deleteTags(["guest"]).then(function(tagsDeleted) {
        console.log('Guest tag deleted');
    ...
    OneSignal.sendTags({
        ...
        console.log('User [[[USERID]]] id set');
    ...
    OneSignal.on('subscriptionChange', function(isSubscribed) {
        ...
        if (isSubscribed) {
            ...
            OneSignal.getUserId( function(userId) {
                $.ajax({
                    method: "POST",
                    url: "onesignal_ajax.php",
                    data: { action: 'receivePlayer', userid: userId}
                })
                    .done(function( msg ) {
